...
# class Turn:
#     #Ask the player how many sticks to pickup
...
class HumanPlayer(Player):
    ...
    def num_of_sticks(self):
        pick_up_sticks("""{}, How many sticks would you like to pick up?
                       Please choose between 1 - 3. """.format(self.name))

        try:
            int(pick_up_sticks)

            if pick_up_sticks not in range(1, 4):
                return self.num_of_stick

            else:
                return pick_up_sticks
